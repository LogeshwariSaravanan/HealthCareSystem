...
//		
	...
	public AppointmentDto addAppointment(AppointmentDto appointmentDto)
	{
		...
		Test test = testRepository.findById(appointmentDto.getTestDto().getTestid()).get();
		 User user = userRepository.findById(appointmentDto.getUserDto().getUserId()).get();
		 DiagnosticCenter center = diagnosticCenterRepository.findById(appointmentDto.getDiagnosticCenterDto().getCenterId()).get();
	   ...
	   //  appointmentDto2.set
	     ...
	     appointmentDto2.setAppointmentId(appointment2.getAppointmentId());
			...
			Test test2 = testRepository.findById(appointment2.getTest().getTestid()).get();
			
			TestDto testDto2 = new TestDto();
			testDto2.setTestid(test2.getTestid());
			testDto2.setTestName(test2.getTestName());
			
		
	     appointmentDto2.setTestDto(testDto2);
	     
	        User user2 = userRepository.findById(appointment2.getUser().getUserId()).get();
	        
	        UserDto userDto2=new UserDto();
	        userDto2.setUserId(user2.getUserId());
	        ...
	        userDto2.setUserEmail(user2.getUserEmail());
	        userDto2.setAge(user2.getAge());
	        userDto2.setGender(user2.getGender());
	        
	     appointmentDto2.setUserDto(userDto2);
	     
	        DiagnosticCenter diagnosticCenter2=diagnosticCenterRepository.findById(appointment2.getDiagnosticCenter().getCenterId()).get();
